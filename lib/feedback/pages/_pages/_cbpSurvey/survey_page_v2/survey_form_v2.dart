...
class SurveyFormV2 extends StatefulWidget {
  ...
  @override
  State<SurveyFormV2> createState() => _SurveyFormV2State();
}

class _SurveyFormV2State extends State<SurveyFormV2> {
  ...
  void submitForm() async {
    if (_formKey.currentState!.validate() &&
      ...
      if (result['statusInfo'] != null &&
        ...
        _showSnackBar(AppLocalizations.of(context)!.mSurveyThanksForSubmitting,
            AppColors.positiveDark);
      } else {
        widget.enrollParentAction!('Failed');
        _showSnackBar(
            AppLocalizations.of(context)!.mStaticSomethingWrong, AppColors.mandatoryRed);
      }
      ...
      _showSnackBar(AppLocalizations.of(context)!.mStaticPleaseFillAllMandatory,
