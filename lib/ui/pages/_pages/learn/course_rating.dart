        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text(
                AppLocalizations.of(context)!.mCommonrateReview,
            ...
            Padding(
              ...
              child: Text(
                AppLocalizations.of(context)!.mCommonyourReviewFeedbackValuable,
                style: GoogleFonts.lato(
            ...
            Padding(
              ...
              child: Text(
                '${AppLocalizations.of(context)!.mLearnRateThis} ${widget.primaryType.toLowerCase()}',
                style: GoogleFonts.lato(
                  color: AppColors.greys87,
                  fontSize: 16.0.sp,
                  fontWeight: FontWeight.w700,
                ...
                ? Column(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(top: 30).r,
                        child: Text(
                          AppLocalizations.of(context)!.mCommongiveReview,
                          style: GoogleFonts.lato(
                            color: AppColors.greys87,
                            fontSize: 16.0.sp,
                            fontWeight: FontWeight.w700,
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                '${AppLocalizations.of(context)!.mCommonaddReview} ${widget.primaryType.toLowerCase()} (${AppLocalizations.of(context)!.mCommonOptional})',
                          ),
                          onChanged: (value) {
