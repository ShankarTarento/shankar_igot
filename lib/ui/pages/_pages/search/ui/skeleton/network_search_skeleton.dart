...
import 'network_request_card_skeleton.dart';


class NetworkSearchSkeleton extends StatefulWidget {
  NetworkSearchSkeleton({
    Key? key,
  }) : super(key: key);

  NetworkSearchSkeletonState createState() => NetworkSearchSkeletonState();
}

class NetworkSearchSkeletonState extends State<NetworkSearchSkeleton>
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _networkListSkeletonView(2),
        ],
      ),
    );
  }

  Widget _networkListSkeletonView(int itemCount) {
    return Container(
      height: 0.68.sh,
