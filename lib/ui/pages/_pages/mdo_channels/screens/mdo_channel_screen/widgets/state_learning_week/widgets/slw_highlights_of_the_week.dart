...
class SlwHighlightsOfTheWeek extends StatefulWidget {
  final Map<String, dynamic> highlightsData;

  const SlwHighlightsOfTheWeek({Key? key, required this.highlightsData})
      : super(key: key);

  @override
  _SlwHighlightsOfTheWeekState createState() => _SlwHighlightsOfTheWeekState();
}

class _SlwHighlightsOfTheWeekState extends State<SlwHighlightsOfTheWeek> {
  ...
  Widget build(BuildContext context) {
    final highlightsList = widget.highlightsData['list'] as List? ?? [];
