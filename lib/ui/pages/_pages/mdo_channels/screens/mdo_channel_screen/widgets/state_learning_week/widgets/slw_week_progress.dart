...
class SlwWeekProgress extends StatefulWidget {
  final String title;
  final String? infoText;
  const SlwWeekProgress({super.key, required this.title, this.infoText});
  static final _controller = PageController();

  @override
  State<SlwWeekProgress> createState() => _WeekProgressState();
}

class _WeekProgressState extends State<SlwWeekProgress> {
  @override
  void initState() {
      ...
      child: Column(
        children: [
          Stack(
            children: [
              ...
              weekProgres?.rank != null
                  ? IntrinsicWidth(
                      child: Container(
                        margin: EdgeInsets.only(top: 25, left: 90).r,
          ...
          Container(
            width: 1.sw,
            decoration: BoxDecoration(
              color: const Color.fromARGB(255, 234, 241, 248),
              borderRadius: BorderRadius.only(
                    ...
                    child: Wrap(
                      ...
                      children: [
                        _insightsWidget(
                            ...
                            title: weekProgres?.totalLearningHours ?? '0'),
                        _insightsWidget(
                            image: Container(
                              height: 28.w,
                              width: 28.w,
                                ...
                                children: [
                                  Expanded(
                                    child: PageView.builder(
                                        controller: SlwWeekProgress._controller,
                                        itemCount:
