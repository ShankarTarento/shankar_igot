...
import 'widgets/explore_events_skeleton.dart';

class ExploreEventsStrip extends StatefulWidget {
  final String startDate;
  final String endDate;
  const ExploreEventsStrip({
  ...
  @override
  State<ExploreEventsStrip> createState() => _ExploreEventsStripState();
}

class _ExploreEventsStripState extends State<ExploreEventsStrip> {
