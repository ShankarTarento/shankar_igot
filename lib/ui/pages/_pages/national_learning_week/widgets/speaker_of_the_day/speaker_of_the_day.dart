...
class SpeakerOfTheDay extends StatefulWidget {
  final Map<String, dynamic> speakerData;

  const SpeakerOfTheDay({Key? key, required this.speakerData})
      : super(key: key);

  @override
  _SpeakerOfTheDayState createState() => _SpeakerOfTheDayState();
}

class _SpeakerOfTheDayState extends State<SpeakerOfTheDay> {
