...
class CommunityItemCarouselWidgetSkeleton extends StatefulWidget {
  CommunityItemCarouselWidgetSkeleton({Key? key, }) : super(key: key);

  CommunityItemCarouselWidgetSkeletonState createState() => CommunityItemCarouselWidgetSkeletonState();
}

class CommunityItemCarouselWidgetSkeletonState extends State<CommunityItemCarouselWidgetSkeleton>
            ...
            child: SlideAnimation(
              ...
              child: FadeInAnimation(
                child: Row(
                  children: [
                    Padding(
                      padding: EdgeInsets.only(left: (index == 0) ? 16 : 8, right: (index < (itemCount - 1)) ? 0 : 16),
