...
class CommunityCompetenciesCard extends StatefulWidget {
  final List<CompetencyArea> competencyAreas;
  final int selectedIndex;
  final int index;
  const CommunityCompetenciesCard(
      {Key? key,
  ...
  @override
  State<CommunityCompetenciesCard> createState() =>
      CommunityCompetenciesCardState();
}

class CommunityCompetenciesCardState extends State<CommunityCompetenciesCard> {
